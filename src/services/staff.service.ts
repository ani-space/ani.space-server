...
export class StaffService implements IStaffService {
  ...
  public async findStaffByIdAnilist(idAnilist: number, saveErrorNotFound?: boolean) {
  ...
  public async saveStaffAlternative(
    ...
    try {
      ...
      this.eventEmitter.emit(LOGGER_CREATED, {
        ...
        errorMessage: JSON.stringify(error),
        tracePath: `StaffService.saveStaffAlternative`,
      } as CreateLoggerDto);
